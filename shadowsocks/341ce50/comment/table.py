...
This program encrypt a string with encrypt_table and then decrypt the string with decrypt_table
...
"""
 Get encrypt table
 I still don't understand the lambda expression very well
